...
public class Application {
	...
	CommandLineRunner init(GuestbookRepository guestbook) {
		...
		return args -> {
			...
			Stream.of( //
					new GuestbookEntry("H4xx0r", "first!!!", "wheat"), //
					new GuestbookEntry("Arni", "Hasta la vista, baby", "skyblue"), //
					new GuestbookEntry("Duke Nukem", "It's time to ", "lime"), //
					new GuestbookEntry("Gump1337", "Mama always said ", "#d8d")) //
